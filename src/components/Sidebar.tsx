  ...
  if (MOBILE) {
    ...
    return (
      <>
        ...
        {/* Bottom tab bar — flush against viewport bottom, no safe-area padding
            (Safari mobile returns a large inset for its bottom toolbar and
            it shows up as dead space inside the nav). */}
