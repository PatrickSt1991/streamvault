  ...
  return (
    <div data-app-root className="flex flex-col w-full h-dvh lg:flex-row overflow-hidden">
      ...
      <main
        ...
        className={cn(
          'flex-1 overflow-y-auto overflow-x-hidden p-4 pt-[calc(8px+env(safe-area-inset-top,0px))] pb-[calc(56px+env(safe-area-inset-bottom,0px))] min-h-0 lg:p-8 lg:px-10 lg:pb-8',
